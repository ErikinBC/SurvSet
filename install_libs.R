...
if (!dir.exists(fold_pkgs)) {
    print('Making folder for local packaes')
...
lst_pkgs = 
list(survival='https://cran.r-project.org/src/contrib/Archive/survival/survival_3.1-11.tar.gz', #2020-04-10 
